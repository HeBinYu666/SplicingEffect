...
The GTF file is used by IsoImpact for transcript and CDS coordinates. The protein IDs in the PfamScan result file should match the protein IDs in the protein FASTA file. The PfamScan result file should retain the original output structure generated by PfamScan, without manual modification.
